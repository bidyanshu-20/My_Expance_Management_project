...
import { ArrowLeft, Eye, EyeOff, Lock, Mail, User, User2 } from 'lucide-react';
const SignUp = ({ onSignup, API_URL = "http://localhost:4000" }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            const res = await axios.post("/api/user/signup", { name, email, password }, { headers: { "Content-Type": "application/json" } },)
            const data = res.data || {};
                    ...
                    <form onSubmit={handleSubmit} noValidate>
                        <div className='mb-6'>
                            ...
                            <div className={signupStyles.inputContainer}>
                                ...
                                <input type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} className={`${signupStyles.input} ${errors.name ? "border-red-300" : "border-gray-200"}`} placeholder='Enter Your Name' />
                            </div>
                        ...
                        <div className='mb-6'>
                            ...
                            <div className={signupStyles.inputContainer}>
                                ...
                                <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} className={`${signupStyles.input} ${errors.email ? "border-red-300" : "border-gray-200"}`} placeholder='your@example.com' />
                            </div>
                        ...
                        <div className='mb-6'>
                            ...
                            <div className={signupStyles.inputContainer}>
                                ...
                                <input type={showPassword ? "text" : "password"} id="password" value={password} onChange={(e) => setPassword(e.target.value)} className={`${signupStyles.input} ${errors.password ? "border-red-300" : "border-gray-200"}`} placeholder='Enter Your Password' />
