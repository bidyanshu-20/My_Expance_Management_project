...
import { ArrowDown, Info, Clock, ArrowUp, Car, CreditCard, DollarSign, Gift, Home, PiggyBank, RefreshCw, ShoppingCart, TrendingUp, Utensils, Zap, ChevronDown, PieChart } from 'lucide-react'
...
const Layout = ({ onLogout, user }) => {
    ...
    // to add a transaction either income or expanse
    ...
    return (
        <div className={styles.layout.root}>
            ...
            <Sidebar user={user} isCollapsed={sidebarCollapsed} setIsCollapsed={sidebarCollapsed} />
                    ...
                    <div className={styles.grid.rightColumn}>
                        <div className={styles.cards.base}>
                            <div className={styles.transactions.cardHeader}>
                                ...
                                <button className={styles.transactions.refreshButton} onClick={fetchTransactions} disabled={loading}>
                                        ...
                                        <div key={id} className={styles.transactions.transactionItem}>
                                            <div className='flex items-center gap-1 md:gap-4 lg:gap-3'>
                                                ...
                                                <div className={styles.transactions.details}>
                                                    ...
                                                    <p className={styles.transactions.meta}>{new Date(false).toLocaleDateString()}
